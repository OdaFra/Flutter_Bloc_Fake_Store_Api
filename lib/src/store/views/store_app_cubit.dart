  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: BlocProvider(
        ...
        child: const _StoreAppCubitView(
          title: 'My Store',
        ),
      ),
    );
...
class _StoreAppCubitView extends StatefulWidget {
  const _StoreAppCubitView({
    required this.title,
  });
  final String title;

  @override
  State<_StoreAppCubitView> createState() => __StoreAppCubitViewState();
}

class __StoreAppCubitViewState extends State<_StoreAppCubitView> {
      ...
      PageRouteBuilder(
        transitionsBuilder: (_, animation, __, child) => SlideTransition(
          ...
          child: BlocProvider.value(
              value: context.read<StoreCubit>(), child: child),
        ),
        pageBuilder: ((_, __, ___) => const CardScreenCubit()),
      ),
    );
  }
